...
<asp:Content ID="Content2" ContentPlaceHolderID="x" runat="server">
    ...
    <asp:Panel ID="datos" runat="server" BackColor="White" Height="98px">
        ...
        <br />
        <asp:Button ID="linkd" runat="server" CssClass="btn-link active" Font-Bold="True" Font-Size="X-Large" Text="Actualizar Datos" ForeColor="#CCFF33" />
        ...
        <div style="text-align:center">
            ...
            <asp:Button ID="estados" runat="server" CssClass="btn" Text="Ver estados de Pedido" BorderColor="#CC33FF" />
        ...
        <div style="text-align:center">
             <asp:Panel ID="pnlpedido" runat="server" Height="269px">
 <br />

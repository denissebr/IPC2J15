...
namespace practica1.ServiceReference1 {
    ...
    public interface Service1Soap {
        ...
        practica1.ServiceReference1.comprobarResponse comprobar(practica1.ServiceReference1.comprobarRequest request);
        ...
        practica1.ServiceReference1.AgregarLibroResponse AgregarLibro(practica1.ServiceReference1.AgregarLibroRequest request);
        
        // CODEGEN: Se está generando un contrato de mensaje, ya que el nombre de elemento nombre del espacio de nombres http://tempuri.org/ no está marcado para aceptar valores nil.
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/AgregarCliente", ReplyAction="*")]
        practica1.ServiceReference1.AgregarClienteResponse AgregarCliente(practica1.ServiceReference1.AgregarClienteRequest request);
    ...
    public partial class comprobarRequest {
        ...
        public practica1.ServiceReference1.comprobarRequestBody Body;
        
        public comprobarRequest() {
        }
        
        public comprobarRequest(practica1.ServiceReference1.comprobarRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class comprobarResponse {
        ...
        public practica1.ServiceReference1.comprobarResponseBody Body;
        
        public comprobarResponse() {
        }
        
        public comprobarResponse(practica1.ServiceReference1.comprobarResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class AgregarLibroRequest {
        ...
        public practica1.ServiceReference1.AgregarLibroRequestBody Body;
        
        public AgregarLibroRequest() {
        }
        
        public AgregarLibroRequest(practica1.ServiceReference1.AgregarLibroRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class AgregarLibroResponse {
        ...
        public practica1.ServiceReference1.AgregarLibroResponseBody Body;
        
        public AgregarLibroResponse() {
        }
        
        public AgregarLibroResponse(practica1.ServiceReference1.AgregarLibroResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class AgregarClienteRequest {
        ...
        public practica1.ServiceReference1.AgregarClienteRequestBody Body;
        
        public AgregarClienteRequest() {
        }
        
        public AgregarClienteRequest(practica1.ServiceReference1.AgregarClienteRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class AgregarClienteResponse {
        ...
        public practica1.ServiceReference1.AgregarClienteResponseBody Body;
        
        public AgregarClienteResponse() {
        }
        
        public AgregarClienteResponse(practica1.ServiceReference1.AgregarClienteResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface Service1SoapChannel : practica1.ServiceReference1.Service1Soap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class Service1SoapClient : System.ServiceModel.ClientBase<practica1.ServiceReference1.Service1Soap>, practica1.ServiceReference1.Service1Soap {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        practica1.ServiceReference1.comprobarResponse practica1.ServiceReference1.Service1Soap.comprobar(practica1.ServiceReference1.comprobarRequest request) {
            return base.Channel.comprobar(request);
        }
        
        public bool comprobar(ref string error) {
            practica1.ServiceReference1.comprobarRequest inValue = new practica1.ServiceReference1.comprobarRequest();
            inValue.Body = new practica1.ServiceReference1.comprobarRequestBody();
            inValue.Body.error = error;
            practica1.ServiceReference1.comprobarResponse retVal = ((practica1.ServiceReference1.Service1Soap)(this)).comprobar(inValue);
            error = retVal.Body.error;
            return retVal.Body.comprobarResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        practica1.ServiceReference1.AgregarLibroResponse practica1.ServiceReference1.Service1Soap.AgregarLibro(practica1.ServiceReference1.AgregarLibroRequest request) {
        ...
        public bool AgregarLibro(string nombre, int existencia, int pagina, string autor, string tema, int disponibles, int prestamos, int reserva) {
            practica1.ServiceReference1.AgregarLibroRequest inValue = new practica1.ServiceReference1.AgregarLibroRequest();
            inValue.Body = new practica1.ServiceReference1.AgregarLibroRequestBody();
            ...
            practica1.ServiceReference1.AgregarLibroResponse retVal = ((practica1.ServiceReference1.Service1Soap)(this)).AgregarLibro(inValue);
            return retVal.Body.AgregarLibroResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        practica1.ServiceReference1.AgregarClienteResponse practica1.ServiceReference1.Service1Soap.AgregarCliente(practica1.ServiceReference1.AgregarClienteRequest request) {
        ...
        public bool AgregarCliente(int carnet, string nombre, long dpi, string direccion, long telefono) {
            practica1.ServiceReference1.AgregarClienteRequest inValue = new practica1.ServiceReference1.AgregarClienteRequest();
            inValue.Body = new practica1.ServiceReference1.AgregarClienteRequestBody();
            inValue.Body.carnet = carnet;
            inValue.Body.nombre = nombre;
            inValue.Body.dpi = dpi;
            inValue.Body.direccion = direccion;
            inValue.Body.telefono = telefono;
            practica1.ServiceReference1.AgregarClienteResponse retVal = ((practica1.ServiceReference1.Service1Soap)(this)).AgregarCliente(inValue);
            return retVal.Body.AgregarClienteResult;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        practica1.ServiceReference1.buscarLibroResponse practica1.ServiceReference1.Service1Soap.buscarLibro(practica1.ServiceReference1.buscarLibroRequest request) {
        ...
        public bool buscarLibro(string nombre) {
            ...
            inValue.Body.nombre = nombre;
            practica1.ServiceReference1.buscarLibroResponse retVal = ((practica1.ServiceReference1.Service1Soap)(this)).buscarLibro(inValue);

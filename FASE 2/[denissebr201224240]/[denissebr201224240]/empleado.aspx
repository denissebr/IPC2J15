...
&nbsp;
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource2" DataKeyNames="DPI" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical">
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:IPC2J15ConnectionString %>" SelectCommand="SELECT [DPI], [Nombre], [Apellido], [Telefono], [NIT], [Domicilio], [Casilla], [Usuario] FROM [Cliente] WHERE ([Nombre] = @Nombre)">
              <SelectParameters>
  ...
  <div class="panel-body">
    <CENTER>
      <asp:GridView ID="GridView2" runat="server" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" DataSourceID="SqlDataSource1" ForeColor="Black" GridLines="None" AutoGenerateColumns="False" DataKeyNames="DPI" >
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:IPC2J15ConnectionString %>" DeleteCommand="DELETE FROM [Cliente] WHERE [DPI] = @original_DPI AND [Nombre] = @original_Nombre AND [Apellido] = @original_Apellido AND (([NIT] = @original_NIT) OR ([NIT] IS NULL AND @original_NIT IS NULL)) AND (([Telefono] = @original_Telefono) OR ([Telefono] IS NULL AND @original_Telefono IS NULL)) AND [Domicilio] = @original_Domicilio AND [Tarjeta] = @original_Tarjeta AND [Casilla] = @original_Casilla AND [Idsucursal] = @original_Idsucursal AND [Usuario] = @original_Usuario AND [Contraseña] = @original_Contraseña AND [Activo] = @original_Activo" InsertCommand="INSERT INTO [Cliente] ([DPI], [Nombre], [Apellido], [NIT], [Telefono], [Domicilio], [Tarjeta], [Idsucursal], [Usuario], [Contraseña], [Activo]) VALUES (@DPI, @Nombre, @Apellido, @NIT, @Telefono, @Domicilio, @Tarjeta, @Idsucursal, @Usuario, @Contraseña, @Activo)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Cliente] WHERE ([Activo] = @Activo)" UpdateCommand="UPDATE [Cliente] SET [Nombre] = @Nombre, [Apellido] = @Apellido, [NIT] = @NIT, [Telefono] = @Telefono, [Domicilio] = @Domicilio, [Tarjeta] = @Tarjeta, [Casilla] = @Casilla, [Idsucursal] = @Idsucursal, [Usuario] = @Usuario, [Contraseña] = @Contraseña, [Activo] = @Activo WHERE [DPI] = @original_DPI AND [Nombre] = @original_Nombre AND [Apellido] = @original_Apellido AND (([NIT] = @original_NIT) OR ([NIT] IS NULL AND @original_NIT IS NULL)) AND (([Telefono] = @original_Telefono) OR ([Telefono] IS NULL AND @original_Telefono IS NULL)) AND [Domicilio] = @original_Domicilio AND [Tarjeta] = @original_Tarjeta AND [Casilla] = @original_Casilla AND [Idsucursal] = @original_Idsucursal AND [Usuario] = @original_Usuario AND [Contraseña] = @original_Contraseña AND [Activo] = @original_Activo">
            <DeleteParameters>
                ...
                <asp:Parameter Name="original_Casilla" Type="Int32" />
